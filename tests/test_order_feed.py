...
class TestOrderFeed:
    ...
    def test_open_window_with_details_order(self, driver):
        window_with_details_order = OrderFeedPage(driver) # Открытие стартовой странице сервиса
    ...
    def test_order_users_in_feed(self, driver):
        order_users = OrderFeedPage(driver)  # Открытие стартовой странице сервиса
    ...
    def test_update_counter_competed_today(self, driver):
        counter_competed_today = OrderFeedPage(driver)  # Открытие стартовой странице сервиса
    ...
    def test_take_order_to_work(self, driver):
        order_to_work = OrderFeedPage(driver)  # Открытие стартовой странице сервиса
