...
class MainPageLocators:
    PERSONAL_ACCOUNT_BUTTON = (By.XPATH, "//p[contains(@class, 'AppHeader_header__linkText') and text() = 'Личный Кабинет']")  # кнопка "Личный кабинет"
    ...
    BURGER_CONSTRUCTOR = (By.XPATH, "//ul[contains(@class, 'BurgerConstructor_basket__list')]")  # Макет бургера, для индивидуального заказа
